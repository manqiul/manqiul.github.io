...
**Why Ensemble method?**: Even if each classifier is a weak learner (meaning it does only slightly better than random guessing), the ensemble can still be a strong learner.
...
{% include figure.html path="assets/img/ensemble/ensemble1.png" class="img-fluid rounded z-depth-1" %}
...
{% include figure.html path="assets/img/ensemble/ensemble2.png" class="img-fluid rounded z-depth-1" %}
